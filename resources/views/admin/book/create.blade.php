                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('publisher') is-invalid @enderror" name="publisher"
                            placeholder="Masukkan Penerbit" value="{{ old('publisher') }}">
                        @error('publisher')
                            <span class="note-help-block text-red">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="" class="form-control @error('description') is-invalid @enderror" rows="6"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('qty_page') is-invalid @enderror" name="qty_page"
