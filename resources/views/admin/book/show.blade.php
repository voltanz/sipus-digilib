            ...
            <div class="card card-info card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        <img class="img-thumnail img-fluid" style="width: 300px;" src="{{ $book->getCover() }}"
            ...
            <div class="card card-info card-outline">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#description" data-toggle="tab">Deskripsi</a>
                        </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="timeline">
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Penerbit</b> <a class="float-right">{{ $book->publisher }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Penulis</b> <a class="float-right">{{ ucwords($book->author->name) }}</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Jumlah Halaman</b> <a class="float-right">{{ $book->qty_page }}</a>
                                </li>
                                <li class="list-group-item">
