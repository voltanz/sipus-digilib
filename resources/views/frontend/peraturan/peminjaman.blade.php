...
@section('content')
    ...
    <div class="container" style="padding-bottom: 8rem">
        <div class="row">
            <div class="col d-flex wow fadeInUp" data-wow-delay="0.3s">
                <div style="padding-right: 15px">
                    <i class="bi bi-person-vcard-fill text-danger"></i>
                </div>
                <div class="me-1">
            ...
            <div class="col d-flex wow fadeInUp" data-wow-delay="0.3s">
                <div style="padding-right: 15px">
                    <i class="bi bi-file-text-fill text-danger" style="font-size: 1.2rem;"></i>
                </div>
                <div class="me-1">
                    <h4>2. SURAT PENGANTAR</h4>
                    <p>Bagi siswa atau masyarakat umum dari luar SMA Negeri 1 Blega hanya diperbolehkan membaca di
                        perpustakaan dengan menunjukkan surat pengantar atau keterangan dari institusi pendidikan tinggi
                        lain, instansi dan identitas resmi.</p>
                </div>
            </div>
            <div class="col d-flex wow fadeInUp" data-wow-delay="0.3s">
                <div style="padding-right: 15px">
        ...
        <div class="row pt-5">
            ...
            <div class="col d-flex wow fadeInUp" data-wow-delay="0.3s">
                <div style="padding-right: 15px">
                    <i class="bi bi-calendar2-event text-danger" style="font-size: 1.2rem;"></i>
                </div>
                <div class="me-1">
            ...
            <div class="col d-flex wow fadeInUp" data-wow-delay="0.3s">
                <div style="padding-right: 15px">
                    <i class="bi bi-calendar2-week-fill text-danger" style="font-size: 1.2rem;"></i>
                </div>
                <div>
        ...
        <div class="row pt-5 pb-5">
            <div class="col-4 d-flex wow fadeInUp" data-wow-delay="0.3s">
                <div style="padding-right: 15px">
                    <i class="bi bi-file-earmark-break-fill text-danger" style="font-size: 1.2rem;"></i>
                </div>
                <div class="me-1">
                    ...
                    <p>Peminjaman buku untuk keperluan pembuatan foto copy sebagian materi/isi buku wajib
                        ...
                        Jangka waktu peminjaman paling lama dua (2) jam dan harus dikembalikan pada hari dan tanggal yang
                        sama.
                        Keterlambatan pengembalian akan dikenakan sanksi denda sebesar Rp 2.500,00 (dua ribu lima ratus
                        rupiah)
