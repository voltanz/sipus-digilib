    ...
    <div class="container">
        <div class="row pb-5">
            <div class="col-6 wow fadeInUp" data-wow-delay="0.3s">
                <section class="bg-image" style="background-image: url('{{ asset('assets/cover/red.jpg') }}');height: 40vh">
                    <div class="container">
                        ...
                        <div class="row pt-5 pb-5">
                            <div class="col-12 text-light">
                                <center>
                                    ...
                                    <h5>Per Buku</h3>
                                        <p>Sanksi atas keterlambatan dari jangka waktu peminjaman atau pengembalian buku
                                            Perpustakaan Pascasarjana dikenakan denda sebesar Rp 2,500,00 setiap buku untuk
