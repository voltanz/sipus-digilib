    ...
    <div class="container"><br>
        <div class="row">
            <div class="col-6">
                ...
                <p style="font-size:1.5rem">07.00 - 14.00</p><br>
                <h4 style="color:orange"><b>Jum'at</b></h4>
                <p style="font-size:1.5rem">07.00 - 10.30</p><br>
                <h4 style="color:orange"><b>Sabtu - Minggu Libur</b></h4><br>
                <h5 style="color:black"><b>Keterangan</b></h5>
                <p class="text-left" style="font-size: 15px;">Proses pelayanan perpustakaan dilakukan dengan tetap mematuhi protokol kesehatan</p>
                <br><br>
              </div>
            </div>
            <div class="col-6">
            <img src="{{ asset('assets/logo/perpus.png') }}" style="width: 700px;" height="400px; left">
            <br><br><br>
            </div>
        </div>
    </div>
